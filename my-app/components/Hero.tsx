            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col
                 items-center justify-center">
                    <h2 className="uppercase tracking-widest text-xs text-center text-blue-80 max-w-80">
                        Dynamic Portfolio with Next.js
                    </h2>
                    <TextGenerateEffect
                        words="Enhance Creativity and Innovation in Development, Desing and Technology"
